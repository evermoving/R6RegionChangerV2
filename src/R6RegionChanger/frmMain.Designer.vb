...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.dropRegion.Items.AddRange(New Object() {"", "default (ping based) [recommended]", "eus (US East)", "cus (US Central)", "scus (US South Central)", "wus (US West)", "sbr (Brazil South)", "neu (Europe North)", "weu (Europe West)", "eas (Asia East)", "seas (Asia South East)", "eau (Australia East)", "(Japan East)"})
